@mod @mod_mrproject @javascript @_file_upload
Feature: Student-supplied data
  In order to collect data from students
  As a teacher
  I can configure a booking form for the mrproject.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | mrproject | Test mrproject | n     | C1     | mrproject1 | 0         | oneonly       | 0           |
  ...
  Scenario: A teacher configures a booking form, and students enter data
    ...
    And I am on "Course 1" course homepage
    And I follow "Test mrproject"
    Then I should see "3:00 AM" in the "meetingbookertable" "table"

    When I click on "Book meeting" "button" in the "3:00 AM" "table_row"
    ...
    And I upload "mod/mrproject/tests/fixtures/studentfile.txt" file to "Upload files" filemanager
    And I click on "Confirm booking" "button"
    Then "Cancel booking" "button" should exist
    And I log out
