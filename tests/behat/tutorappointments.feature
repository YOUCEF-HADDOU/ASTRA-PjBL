@mod @mod_mrproject
Feature: Booking of tasks with individual tutors per group
  In order to organize tasks with the students in my group
  As a tutor
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | mrproject | Tutor sessions | n     | C1     | mrproject1 | 1         | oneonly       | 0           |
    And I add the upcoming events block globally

  @javascript
  Scenario: A tutor adds meetings, and students book them
    When I log in as "tutor2"
    And I am on "Course 1" course homepage
    And I add 10 meetings 5 days ahead in "Tutor sessions" mrproject and I fill the form with:
      | Location | My office |
    ...
    And I should not see "students still need to make an task"
    And I log out

  @javascript
  Scenario: Several tutors add meetings, they can be seen only by relevant users
    ...
    Then I should see "1:00 AM" in the "meetingbookertable" "table"
    And I should see "10:00 AM" in the "meetingbookertable" "table"
    And I should see "Coordinator 1" in the "meetingbookertable" "table"
    And I should not see "Tutor 2" in the "meetingbookertable" "table"
    And I should not see "Tutor 3" in the "meetingbookertable" "table"
    ...
    Then I should see "1:00 AM" in the "meetingbookertable" "table"
    And I should see "10:00 AM" in the "meetingbookertable" "table"
    And I should not see "Coordinator 1" in the "meetingbookertable" "table"
    And I should see "Tutor 2" in the "meetingbookertable" "table"
    And I should not see "Tutor 3" in the "meetingbookertable" "table"
    When I click on "Book meeting" "button" in the "2:00 AM" "table_row"
    Then "Cancel booking" "button" should exist
    And I should see "Meeting with your Teacher, Tutor 2" in the "Upcoming events" "block"
    ...
    And I am on "Course 1" course homepage
    And I follow "Tutor sessions"
    Then I should see "Student 1a" in the "meetingmanager" "table"
    And I should not see "Student 1b" in the "meetingmanager" "table"
    And I should not see "Student 2a" in the "meetingmanager" "table"
    ...
    Then I should see "Student 1a" in the "meetingmanager" "table"
    And I should not see "Student 1b" in the "meetingmanager" "table"
    And I should see "Student 2a" in the "meetingmanager" "table"
    And I log out

    When I log in as "tutor2"
    And I am on "Course 1" course homepage
    And I follow "Tutor sessions"
    Then I should not see "Student 1a" in the "meetingmanager" "table"
    And I should not see "Student 1b" in the "meetingmanager" "table"
    And I should see "Student 2a" in the "meetingmanager" "table"
    ...
    Then "meetingmanager" "table" should not exist
