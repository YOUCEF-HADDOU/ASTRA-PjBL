@mod @mod_mrproject
Feature: Teacher can add meetings to a mrproject activity
  In order to allow students to book a meeting
  As a teacher
  I need to add meetings to the mrproject
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | mrproject | Test mrproject | n     | C1     | mrproject1 |

  @javascript
  Scenario: Teacher adds a single, empty meeting to the mrproject
    When I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test mrproject"
    And I click on "Add meetings" "link"
    And I follow "Add single meeting"
    ...
    Then I should see "1 meeting added"
    And I should see "Friday, 1 April 2050"

  @javascript
  Scenario: Teacher enters invalid values when adding a meeting
    When I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test mrproject"
    And I click on "Add meetings" "link"
    ...
    And I set the following fields to these values:
      | exclusivity      | 5     |
    And I click on "Save changes" "button"
    And I should see "1 meeting added"

  @javascript
  Scenario: Teacher enters a meeting and schedules 3 students
    When I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test mrproject"
    And I click on "Add meetings" "link"
  ...
  @javascript
  Scenario: Teacher creates 10 meetings at once
    When I log in as "teacher1"
    And I am on "Course 1" course homepage
