@mod @mod_mrproject
Feature: Users can only see their own groups if the mrproject is in group mode
  In order to see meetings
  As a user
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | mrproject | Test mrproject none     | n     | C1     | mrprojectn | 0         |
      | mrproject | Test mrproject separate | n     | C1     | mrprojects | 1         |
      | mrproject | Test mrproject visible  | n     | C1     | mrprojectv | 2         |
    And the following "permission overrides" exist:
      | capability                  | permission | role    | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | teacher | Course       | C1        |
      | mod/mrproject:canseeotherteachersbooking | Allow | teacher | Course  | C1     |
    And I add the upcoming events block globally
    And I log in as "edteacher1"
    And I am on "Course 1" course homepage
    And I add 5 meetings 10 days ahead in "Test mrproject none" mrproject and I fill the form with:
      | Location  | Here |
    And I am on "Course 1" course homepage
    And I add 5 meetings 11 days ahead in "Test mrproject visible" mrproject and I fill the form with:
      | Location  | Here |
    And I am on "Course 1" course homepage
    And I add 5 meetings 12 days ahead in "Test mrproject separate" mrproject and I fill the form with:
      | Location  | Here |
    And I log out
  ...
  @javascript
  Scenario: Editing teachers can see all meetings and all groups
    When I log in as "edteacher1"
    And I am on "Course 1" course homepage
    And I follow "Test mrproject none"
    And I follow "Statistics"
    And I follow "All tasks"
    Then I should see "Editingteacher 1" in the "meetingmanager" "table"
    And I should see "Nonedteacher 1" in the "meetingmanager" "table"
    ...
    And I follow "Test mrproject visible"
    And I follow "Statistics"
    And I follow "All tasks"
    ...
    Then I should see "Editingteacher 1" in the "meetingmanager" "table"
    And I should not see "Nonedteacher 1" in the "meetingmanager" "table"
    When I set the field "group" to "Group B"
    Then I should see "Editingteacher 1" in the "meetingmanager" "table"
    And I should see "Nonedteacher 1" in the "meetingmanager" "table"
    When I set the field "group" to "Group C"
    Then I should not see "Editingteacher 1" in the "meetingmanager" "table"
    And I should see "Nonedteacher 1" in the "meetingmanager" "table"

    When I am on "Course 1" course homepage
    And I follow "Test mrproject separate"
    And I follow "Statistics"
    And I follow "All tasks"
    ...
    # In the "My tasks" tab, the teacher should only see students to schedule from their groups,
    # i.e., groups A and B.
  ...
  Scenario: Nonediting teachers can see groups only if allowed by the group mode
    ...
    And I follow "Statistics"
    And I follow "My tasks"
    Then I should see "6 students still need to make an task"
    ...
    And I follow "Statistics"
    And I follow "My tasks"
    Then I should see "2 students still need to make an task"
    When I follow "All tasks"
    Then I should see "Visible groups"
    And the "group" select box should contain "All participants"
    And the "group" select box should contain "Group A"
    ...
    And I should see "students cannot book tasks with you"
  ...
  @javascript
  Scenario: Students can see meetings available to their own groups, or a meetings if group mode is off
    ...
    When I am on "Course 1" course homepage
    And I follow "Test mrproject visible"
    Then I should see "No meetings are available"
    When I am on "Course 1" course homepage
    And I follow "Test mrproject separate"
    Then I should see "No meetings are available"
    And I log out
  ...
  @javascript
  Scenario: Students can see meetings available to their own groups in forced group mode
    When I log in as "edteacher1"
    And I am on "Course 1" course homepage
    ...
    Then I should see "Test mrproject none"
    And I log out
