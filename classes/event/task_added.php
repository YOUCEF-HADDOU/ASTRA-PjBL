 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class task_added extends task_base {
    ...
    public static function get_name() {
        return get_string('event_taskadded', 'mrproject');
    }
    ...
    public function get_description() {
        return "A new task with id '{$this->objectid}' has been assigned to the student with id '{$this->relateduserid}' during the meeting with id  '{$this->other}'"
                ." in the [MRProject activity module] with course_module id '$this->contextinstanceid'.";

        /*return "A new task has been created for '{$this->relateduserid}' during the meeting with id  '{$this->objectid}'"
                ." in the [MRProject activity module] with course_module id '$this->contextinstanceid'.";  */      
    } 
}
