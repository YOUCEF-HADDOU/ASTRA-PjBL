 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dependency_added extends task_base {
    ...
    public static function get_name() {
        return get_string('event_dependencyadded', 'mrproject');
    }
    ...
    public function get_description() {
        return "The student with id '$this->userid' added a new dependency related to the task with id  '{$this->objectid}'"
