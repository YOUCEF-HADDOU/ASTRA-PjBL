 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class meeting_report_viewed extends meeting_base {
    ...
    public static function get_name() {
        return get_string('event_meetingreportviewed', 'mrproject');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the report of the meeting with id  '{$this->objectid}'" ." in the [MRProject activity module] " .
