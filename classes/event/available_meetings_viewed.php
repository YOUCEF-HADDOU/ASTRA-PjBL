 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class available_meetings_viewed extends mrproject_base {
    ...
    public static function get_name() {
        return get_string('event_availablemeetingsviewed', 'mrproject');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the available meetings in the [MRProject activity module] " .
