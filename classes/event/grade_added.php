 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class grade_added extends task_base {
    ...
    public static function get_name() {
        return get_string('event_gradeadded', 'mrproject');
    }
    ...
    public function get_description() {
        return "The teacher with id '$this->userid' evaluated the student with id '{$this->relateduserid}' for the task with id  '{$this->objectid}'"
