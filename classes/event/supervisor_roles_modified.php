 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class supervisor_roles_modified extends mrproject_base {
    ...
    public static function get_name() {
        return get_string('event_supervisorrolesmodified', 'mrproject');
    }
    ...
    public function get_description() {
        return "The teacher with id '$this->userid' has modified the supervisor roles  "
