...
/**
 * Defines the mod_mrproject meeting updated event.
 *
...
/**
 * The mod_mrproject meeting updated event.
 *
 * Indicates that a teacher has updated a meeting.
 *
 * @package     mod_mrproject
 * @copyright   2024 Youcef Haddou <youcef.haddou@univ-tiaret.dz>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class meeting_updated extends meeting_base {
    ...
    public static function get_name() {
        return get_string('event_meetingupdated', 'mrproject');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the meeting with id  '{$this->objectid}'"
