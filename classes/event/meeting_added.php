 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class meeting_added extends meeting_base {
    ...
    public static function get_name() {
        return get_string('event_meetingadded', 'mrproject');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the meeting with id  '{$this->objectid}'"
