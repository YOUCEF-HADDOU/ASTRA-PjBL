 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class meeting_report_edited extends meeting_base {
    ...
    public static function get_name() {
        return get_string('event_meetingreportedited', 'mrproject');
    }
    ...
    public function get_description() {
        return "The student with id '$this->userid' edited the report of the meeting with id  '{$this->objectid}'"
