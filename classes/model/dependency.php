...
/**
 * A class for representing a task dependency.
 *
 * @copyright   2024 Youcef Haddou <youcef.haddou@univ-tiaret.dz>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dependency extends mvc_child_record_model {


    /**
     * Create an dependency in a specific task
     *
     * @param task $task
     */
    public function __construct(task $task) {
        ...
        $this->set_parent($task);
        $this->data->taskid = $task->get_id();
    ...
    public function save() {
        $this->data->taskid = $this->get_parent()->get_id();
        parent::save();
    ...
    /**
     * Retrieve the task associated with this dependency
     *
     * @return task;
     */
